    ...
    <div className="footer">
        <div className="container">
            <div className="footer-left col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <p>Star on GitHub</p>
                <a class="github-button" href="https://github.com/victorlenerd/houserents" data-size="large" data-show-count="true" aria-label="Star victorlenerd/houserents on GitHub">Star</a>
            </div>
