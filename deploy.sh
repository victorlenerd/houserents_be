...
gcloud builds submit --tag gcr.io/crib-com/houserents-dev-api .
"houserents-dev-api" | gcloud beta run deploy --image gcr.io/crib-com/houserents-dev-api --platform managed